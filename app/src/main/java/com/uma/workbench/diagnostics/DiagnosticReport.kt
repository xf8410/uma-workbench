...
data class DiagnosticReport(val appVersion: String, val androidVersion: String, val abi: List<String>, val taskId: String?, val stage: String?, val lastSuccessfulEvent: String?, val errorCode: String?, val message: String?)
