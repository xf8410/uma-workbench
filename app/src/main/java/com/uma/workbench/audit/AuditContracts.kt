...
data class AuditBudget(val maxFiles: Int = 500, val maxSingleFileBytes: Long = 8L * 1024 * 1024, val maxRuntimeSeconds: Long = 300, val maxOutputCharacters: Int = 100_000)
...
interface SourceAuditor {
    ...
    suspend fun audit(sourceId: String, checkpoint: AuditCheckpoint?, budget: AuditBudget): AuditCheckpoint
}
